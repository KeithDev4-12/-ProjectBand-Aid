...
begin
  ...
  while not tblConsumerAccount.EOF do begin
    ...
    if tblConsumerAccountaccountname.AsString.Contains('Ñ') then begin
      vtConsumerAccountaccountname.AsString :=        StringReplace(tblConsumerAccountaccountname.AsString,'Ñ','�',[rfReplaceAll, rfIgnoreCase]);
    end else begin
